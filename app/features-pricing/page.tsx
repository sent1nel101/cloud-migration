        ...
        <div className="page-container">
              ...
              <div className="feature-tier">
                ...
                <div className="feature-list">
                  <div className="feature-item">
                    ...
                    <p>
                      Get a personalized 4-phase migration path tailored to
                      your career goals
                    </p>
                  </div>
                  <div className="feature-item">
                    ...
                    <p>
                      Identify exactly what skills you need to develop for your
                      target role
                    </p>
                  </div>
                  <div className="feature-item">
                    ...
                    <p>
                      Realistic month-by-month timeline to complete your career
                      transition
                    </p>
                  </div>
                  <div className="feature-item">
                    ...
                    <p>
                      Explore alternative roles and progression options in your
                      industry
                    </p>
                  </div>
                  <div className="feature-item">
                    ...
                    <p>
                      Market-based salary ranges for your target role and
                      location
                    </p>
                  </div>
                  <div className="feature-item">
                    ...
                    <p>
                      Export your personalized roadmap as a PDF for offline
                      reference
                    </p>
                  </div>
                </div>
              ...
              <div className="feature-tier featured">
                ...
                <div className="feature-list">
                  ...
                  <div className="feature-item">
                    ...
                    <p>
                      Specific tips for tailoring your resume to your target
                      role
                    </p>
                  </div>
              ...
              <div className="feature-tier">
                ...
                <div className="feature-list">
                  ...
                  <div className="feature-item">
                    ...
                    <p>
                      Get an AI-optimized resume tailored to your target role
                    </p>
                  </div>
                  <div className="feature-item">
                    <h4>Multiple Resume Versions</h4>
                    <p>
                      Generate multiple resume versions for different job types
                    </p>
                  </div>
                  <div className="feature-item">
                    <h4>LinkedIn Profile Optimization</h4>
                    <p>
                      Specific copy suggestions to optimize your LinkedIn
                      profile
                    </p>
                  </div>
                  <div className="feature-item">
          ...
          <section className="pricing-faq">
            ...
            <div className="faq-item">
              ...
              <p>
                Yes. The free tier gives you access to your complete 4-phase
                career roadmap, skill gap analysis, and timeline forever. No
                credit card needed, no limits.
              </p>
            </div>
            ...
            <div className="faq-item">
              ...
              <p>
                Absolutely. Start with the free tier and upgrade to
                Professional or Premium anytime. Your roadmap data will be
                saved.
              </p>
            </div>
            ...
            <div className="faq-item">
              ...
              <p>
                ...
                Express), PayPal, and Google Pay. All payments are processed
                securely.
              </p>
            </div>
          </section>
          ...
          <section className="pricing-cta">
            ...
            <p>
              Start your free roadmap generation today. No credit card
              required.
            </p>
